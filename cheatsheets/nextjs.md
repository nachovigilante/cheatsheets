...
- [Rutas del backend](#rutas-del-backend)
    ...
    - [Dandole un codigo de status a una respuesta](#dándole-un-código-de-status-a-una-respuesta)
...
Puedes crear un nuevo proyecto usando:
...
esto va a crear una plantilla común y corriente de Next.js, si queres usar typescript debes agregar --typescript luego del create-next-app y eso se veria algo así:
...
podes ver que aparte de npm/npx estamos usando yarn o pnpm que son package managers más nuevos que suelen tener un mejor rendimiento.


es muy recomendable investigar sobre create-t3-app si estas usando next/auth, tRPC, Typescript, o Tailwindcss con next.js. [ver mas sobre create-t3-app](https://create.t3.gg/)


[ver mas](https://nextjs.org/docs/getting-started)
...
Next.js usa un sistema de archivos como rutas que significa que cualquier archivo dentro del directorio pages se considerará una ruta nueva.
...
[ver mas](https://nextjs.org/docs/api-routes/introduction)


### Rutas indice


El servidor automáticamente convierte cualquier archivo index.js a su índice. Osea si vos tenes `/blog/index.js` eso sería equivalente a `/blog` en el buscador.


[ver mas](https://nextjs.org/docs/routing/introduction#index-routes)


### Rutas Dinamicas


Las rutas dinámicas en Next.js se hacen poniendo el nombre del archivo entre `[]`. Por ejemplo: `/blog/post/[id].js` esto va a crear una ruta dinámica después de `/post`. Para acceder a la info ingresada a la ruta dinámica podes usar el parámetro dentro de `getInitialProps(ctx)/getServerSideProps(ctx)`. Tambien podes usar el `useRouter()` hook. Si se ingresa a /blog/post/123 este código pondría en display Post: 123.
...
en el caso de que tus rutas necesiten más de una ruta dinámica podes tener rutas dinámicas con rutas dinámicas poniendo `[]` a el nombre de la carpeta. Por ejemplo /blog/[postName]/[id].js. El hook useRouter devolverá algo así:


```json
{"postName": "...", "id": "..."}
```
[ver mas](https://nextjs.org/docs/routing/dynamic-routes)


## Next Link


next/link esta bueno de usar ya que precarga tus páginas a las que linkeas mejorando el rendimiento cuando el usuario aprieta cualquier link. Un ejemplo del next/link en uso sería:
...
```
[ver mas](https://nextjs.org/docs/routing/introduction#linking-between-pages)
...
```
[ver mas](https://nextjs.org/docs/basic-features/pages)
...
[ver mas](https://nextjs.org/docs/basic-features/pages#two-forms-of-pre-rendering)
...
[ver mas](https://nextjs.org/docs/basic-features/pages#static-generation-without-data)
...
```
[ver mas](https://nextjs.org/docs/basic-features/pages#scenario-1-your-page-content-depends-on-external-data)
...
[ver mas](https://nextjs.org/docs/basic-features/pages#server-side-rendering)
...
[ver mas](https://nextjs.org/docs/basic-features/data-fetching/incremental-static-regeneration)
...
```
[ver mas](https://nextjs.org/docs/basic-features/data-fetching/client-side#client-side-data-fetching-with-useeffect)
...
[ver mas](https://nextjs.org/docs/api-routes/response-helpers)
...
```
[ver mas](https://nextjs.org/docs/api-routes/response-helpers#setting-the-status-code-of-a-response)
...
[ver mas](https://nextjs.org/docs/api-routes/request-helpers#extending-the-reqres-objects-with-typescript)
...
[ver mas](https://nextjs.org/docs/basic-features/data-fetching/incremental-static-regeneration#self-hosting-isr)
...
[ver mas](https://nextjs.org/docs/deployment)
