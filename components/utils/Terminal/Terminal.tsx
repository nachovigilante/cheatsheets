...
const WindowHeader = () => {
    return (
        <div className="bg-[#2a2831] font-space 2xl:h-20 h-[70px] md:text-2xl sm:text-xl text-lg flex items-center border-b-1 border-b-black">
            <div className="flex md:gap-3 gap-2 2xl:p-5 p-4 self-start">
                <div className="bg-[#ff5f56] 2xl:w-5 2xl:h-5 md:w-4 md:h-4 h-3 w-3 rounded-full" />
                <div className="bg-[#ffbd2e] 2xl:w-5 2xl:h-5 md:w-4 md:h-4 h-3 w-3 rounded-full" />
                <div className="bg-[#27c93f] 2xl:w-5 2xl:h-5 md:w-4 md:h-4 h-3 w-3 rounded-full" />
            </div>
