        ...
        <>
            <div className="relative z-20 p-0 3xl:max-w-[1200px] 2xl:max-w-[1000px] xl:max-w-[900px] lg:max-w-[800px] md:max-w-[640px] sm:max-w-[450px] max-w-[320px] m-auto">
                ...
                <section className="flex justify-start items-center lg:pl-20 2xl:pl-0 md:pl-10 sm:pl-8">
                    <div className="relative 3xl:h-[800px] 2xl:h-[700px] xl:h-[600px] lg:h-[400px] md:h-[400px] sm:h-[350px] xs:h-[300px] xl:mt-0 lg:mt-20 flex flex-col justify-center z-20 items-start">
                        <h1 className="flex lg:gap-5 sm:gap-2 flex-col 3xl:text-9xl 2xl:text-8xl xl:text-7xl lg:text-6xl md:text-5xl sm:text-4xl relative z-20 font-raleway font-black w-full drop-shadow-md">
                            <span>TIC</span>
                        ...
                        <a
                            href="#terminal"
                            className="2xl:text-xl lg:text-lg md:text-sm sm:text-xs font-space font-semibold xl:mt-20 lg:mt-16 md:mt-12 sm:mt-8 relative z-20 no-ligature bg-black/20 border px-4 py-2 rounded-lg self-start hover:bg-black/30"
                        >
                            {"> Ir a la terminal"}
                        </a>
                        <img
                            src="/assets/images/notebook.png"
                            className="absolute top-30 3xl:left-[480px] 2xl:left-[400px] xl:left-[380px] lg:left-[300px] md:left-[250px] sm:left-[170px] lg:w-[380px] md:w-[320px] sm:w-[250px] 3xl:w-[800px] 2xl:w-[600px] xl:w-[400px] drop-shadow-notebook"
                            alt="notebook"
                        />
                    </div>
                </section>
                <Section className="md:my-40 mb-16">
                    <Glassbox className="2xl:max-w-4xl xl:max-w-[800px] lg:max-w-[600px] max-w-full">
                        <div className="flex justify-between">
                            <h2 className="3xl:text-3xl 2xl:text-2xl xl:text-xl md:text-lg font-space font-medium no-ligature">
                        ...
                        <p className="3xl:text-xl xl:text-base md:text-sm sm:text-xs font-space font-extralight mt-3">
                        ...
                        <div className="flex justify-between items-center">
                            <p className="3xl:text-xl 2xl:text-lg xl:text-base md:text-sm sm:text-xs font-space font-extralight">
